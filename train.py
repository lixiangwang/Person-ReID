...
#parser.add_argument('--data_dir',default='/home/lxwang/MyProjects/first_test_reid/Market/pytorch',type=str, help='training dir path')
#parser.add_argument('--data_dir',default='/home/lxwang/MyProjects/first_test_reid/DukeMTMC-reID/pytorch',type=str, help='training dir path')
parser.add_argument('--data_dir',default='/home/lxwang/MyProjects/first_test_reid/cuhk03_hand/pytorch',type=str, help='training dir path')
